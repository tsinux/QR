...
import pub.iyu.zxing.camera.CameraManager;
import pub.iyu.zxing.decoding.CaptureActivityHandler;
import pub.iyu.zxing.decoding.InactivityTimer;
import pub.iyu.zxing.decoding.RGBLuminanceSource;
import pub.iyu.zxing.view.ViewfinderView;
/**
 * Initial the camera
 */
...
//		playBeepSoundAndVibrate();
		...
		if (resultString.equals("")) {
			Toast.makeText(MipcaActivityCapture.this, "二维码损坏了", Toast.LENGTH_SHORT).show();
		}else {
